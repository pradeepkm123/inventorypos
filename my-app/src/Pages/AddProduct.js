...
const BRANDS_API = 'https://inventoryapi.cctvshoppee.com/api/brands';
const CATEGORIES_API = 'https://inventoryapi.cctvshoppee.com/api/categories';
const SUBCATEGORIES_API = 'https://inventoryapi.cctvshoppee.com/api/subcategories';
...
const AddProduct = ({
  ...
  const previewSrc = useMemo(() => {
    ...
    if (typeof img === 'string' && img.trim()) {
      ...
      // fallback without helper: keep it as-is or prefix uploads
      if (/^https?:\/\//i.test(img) || img.startsWith('/uploads/')) return img;
      return `https://inventoryapi.cctvshoppee.com/uploads/${img}`;
    }

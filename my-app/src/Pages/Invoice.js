...
function Invoice() {
  ...
  useEffect(() => {
    const fetchDispatches = async () => {
      try {
        const response = await axios.get('https://inventoryapi.cctvshoppee.com/api/dispatch');
  ...
  const handleConfirmDelete = async () => {
    try {
      await axios.delete(`https://inventoryapi.cctvshoppee.com/api/dispatch/${selectedId}`);
